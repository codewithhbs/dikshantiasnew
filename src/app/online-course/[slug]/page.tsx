   ...
   <div className="container max-w-7xl mx-auto p-6">
      ...
      <div className="bg-blue-100 rounded-2xl p-6 mb-6 flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1">
          <Skeleton height={30} width="50%" className="mb-4" /> {/* Course Title */}
          ...
          <div className="flex gap-3">
            <Skeleton height={30} width={80} /> {/* Badge */}
            <Skeleton height={30} width={100} /> {/* Review */}
          </div>
        </div>
                    ...
                    <div className="w-full lg:w-80">
                        <div className="lg:sticky lg:top-8">
                            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                                ...
                                <div className="p-6">
                                    <div className="flex items-center gap-3 text-3xl font-bold text-[#040c33] mb-6">
                                        <span>₹ {course.price}</span>
                                        <del className="text-gray-400">₹ {course.originalPrice}</del>
                                    ...
                                    <div className="space-y-4 text-sm">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-blue-950">Lectures: {course.lectures}</span>
                                        </div>
                                        <div className="flex items-center gap-3">
