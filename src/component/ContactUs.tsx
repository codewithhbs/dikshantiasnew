              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4 group">
                  ...
                  <span className="text-slate-700 font-medium">
                    <span className='font-bold'>{t('contacts.mainOffice')}: </span> {settings?.address}
                  </span>
                </div>
                ...
                <div className="flex items-center space-x-4 group">
                  ...
                  <span className="text-slate-700 font-medium">
                    <span className='font-bold'>{t('contacts.emailUs')}:</span> {settings?.email}
                  </span>
                </div>
                ...
                <div className="flex items-center space-x-4 group">
                  ...
                  <span className="text-slate-700 font-medium">
                    <span className='font-bold'>{t('contacts.phone')}:</span> {settings?.phone}
                  </span>
                </div>
              </div>
            </div>
